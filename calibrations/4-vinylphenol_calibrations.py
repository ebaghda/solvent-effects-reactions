...
VP.to_csv(r"calibrations/4-vinylphenol_calibrations.csv") #export the data to a .csv

from calibrations.plot_calibration_curve import plot_calibration_curve1 #import calibration curve plot assist function
...
fig.savefig("calibrations/4-vinylphenol_calibrations_900dpi.png", dpi=900, bbox_inches='tight') #save the figure as a 900 dpi .png
