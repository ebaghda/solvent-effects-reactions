...
EP = pd.read_csv(r"./calibrations/ethylphenol_calibrations.csv") #import data
...
plt.savefig("./calibrations/ethylphenol_RRF_900dpi.png", dpi=900, bbox_inches='tight') #save figure as 900 dpi .png
