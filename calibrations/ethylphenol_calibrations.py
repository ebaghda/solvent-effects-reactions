...
EP.to_csv(r'calibrations/ethylphenol_calibrations.csv') #export the data to a .csv

from calibrations.plot_calibration_curve import plot_calibration_curve #import custom calibration curve plotting helper function
...
fig.savefig("calibrations/ethylphenol_calibrations_900dpi.png", dpi=900, bbox_inches='tight') #save figure as 900 dpi .png
