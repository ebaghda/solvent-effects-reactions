...
df = DF[(DF["catalyst"] == "Pt") & (DF["temperature_C"] == 75) & (DF["formate_mM"] == 100) & (DF["stock_batch_number"] >= 0)] #filter the data
...
plt.savefig("ethylphenol_generation_vs_IPA_concentration_Pt_100mMPF_900dpi.png", bbox_inches="tight", dpi=900) #save the figure as a 900 dpi .png
print('figure saved to "ethylphenol_generation_vs_IPA_concentration_Pt_100mMPF_900dpi.png"') #print success message