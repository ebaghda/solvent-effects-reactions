...
plt.savefig("ethylphenol_generation_vs_IPA_concentration_900dpi.png", bbox_inches="tight", dpi=900) #save the figure as a 900 dpi .png
print('figure saved to "ethylphenol_generation_vs_IPA_concentration_900dpi.png"') #print success message