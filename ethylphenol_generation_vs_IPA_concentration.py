...
df[df["IPA_molefrac"] == 0.0].plot.scatter("IPA_molefrac", "EP_generation_rate", ax=ax, label="0% IPA",s=60, c="b", edgecolor="k")
df[df["IPA_molefrac"] == 0.1].plot.scatter("IPA_molefrac", "EP_generation_rate", ax=ax, label="10% IPA",s=60, c="#58a8f9", edgecolor="k")
df[df["IPA_molefrac"] == 0.2].plot.scatter("IPA_molefrac", "EP_generation_rate", ax=ax, label="20% IPA",s=60, c="g",edgecolor="k")

plt.xlabel("IPA Concentration (mole/mole)", labelpad=15, fontsize=24)
plt.ylabel("Ethylphenol Generation Rate (mM/g s)", labelpad=15, fontsize=24)
ax.set_xticklabels(["0", "0.1", "0.2"], fontsize=20)
