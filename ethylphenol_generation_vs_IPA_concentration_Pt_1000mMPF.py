...
df = DF[(DF["catalyst"] == "Pt") & (DF["temperature_C"] == 75) & (DF["formate_mM"] == 1000) & (DF["stock_batch_number"] >= 0)] #filter the data
...
print('figure saved to "ethylphenol_generation_vs_IPA_concentration_Pt_1000mMPF_900dpi.png"') #print success message